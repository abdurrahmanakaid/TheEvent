            ...
            <div className='card mb-5 mb-lg-0'>
              <div className='card-body'>
                ...
                <div className='text-center'>
                  <button type='button' className='btn' data-bs-toggle='modal' data-bs-target='#buy-ticket-modal' data-ticket-type='standard-access'>
                    Buy Now
                  </button>
                </div>
              </div>
          ...
          <div className='col-lg-4' data-aos='fade-up' data-aos-delay={200}>
            <div className='card mb-5 mb-lg-0'>
              <div className='card-body'>
                ...
                <hr />
                <div className='text-center'>
                  <button type='button' className='btn' data-bs-toggle='modal' data-bs-target='#buy-ticket-modal' data-ticket-type='pro-access'>
                    Buy Now
                  </button>
                </div>
              </div>
          ...
          <div className='col-lg-4' data-aos='fade-up' data-aos-delay={300}>
            <div className='card'>
              <div className='card-body'>
                ...
                <hr />
                <div className='text-center'>
                  <button type='button' className='btn' data-bs-toggle='modal' data-bs-target='#buy-ticket-modal' data-ticket-type='premium-access'>
                    Buy Now
                  </button>
                </div>
              </div>
